...
public class SingleSchemaLiquibaseSupport {
    ...
    public static SingleSchemaLiquibaseSupport baseInstance(DataSource dataSource, LiquibaseProperties liquibaseProperties, String schema) {
        var liquibase = new SingleSchemaLiquibaseSupport();
        liquibase.dataSource = dataSource;
        liquibase.schema = schema;
        liquibase.changeLog = liquibaseProperties.getChangeLog();
        return liquibase;
    }
